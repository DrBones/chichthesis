...
\newfloatcommand{capbtabbox}{table}[][206pt]
...
\addbibresource{ego_depletion_final_latin.bib}
...
\definecolor{likingcyan2}{HTML}{98D9E6}
\definecolor{riskred}{HTML}{C1504D}
\definecolor{riskred2}{HTML}{DB5758}
\definecolor{depletionred}{HTML}{A84A44}
\definecolor{nondepletiongreen}{HTML}{89A24C}
\definecolor{nored}{HTML}{E76B69}
\definecolor{yesblue}{HTML}{669CE2}
...
\newpagestyle{bib}{%
  \headrule
  \sethead[Bibliography][][]{}{}{Bibliography}
  % \footrule
\renewcommand{\makefootrule}{%
  % \makebox[0pt][l]{\rule[.7\baselineskip]{\linewidth}{0.8pt}}%
  % \color{red}%
...
\usepackage[format=plain,indention=.2cm]{caption}
